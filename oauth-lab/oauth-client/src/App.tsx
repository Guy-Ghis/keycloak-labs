...
function App() {
  ...
  const handleLogout = () => {
    ...
    const logoutUrl = `http://10.216.68.222:7000/realms/test-realm/protocol/openid-connect/logout?client_id=Spring-Client&post_logout_redirect_uri=${encodeURIComponent('http://localhost:5173')}`;
  ...
  return (
      <div className="app">
        {currentUser && (
          <button onClick={handleLogout} className="logout-btn logout-btn-top">
            Sign Out
          </button>
        )}
        <div className="container">
          <div className="welcome-header">
            ...
            <p>You are now securely signed in.</p>
          </div>
          <div className="welcome-content">
            <div className="welcome-message">
